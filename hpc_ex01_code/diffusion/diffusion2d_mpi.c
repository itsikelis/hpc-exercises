                ...
                const int procs)
{
    ...
    // TODO - Calculate local N based on squares.
...
void advance(Diffusion2D *D2D)
{
    ...
    // TODO - Add right and left neighbour. Now only northern and southern are involved.
    ...
    {
        // TODO:MPI
        // TODO - Determine how to break matrix in equal squares and give them to processes.
    ...
    for (int i = 2; i < local_N_; ++i) {
        // TODO - j should end in square limit local_M_.
        for (int j = 1; j <= N_; ++j) {
    ...
    // TODO - Add MPI wait here for async. Remove for sync.
